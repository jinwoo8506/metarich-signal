              ...
              <table className="w-full text-left font-black">
                <thead className="bg-black text-[#d4af37] text-[10px] uppercase font-black">
                  <tr>
                    ...
                    <th className="p-6 text-center">1W</th>
                    <th className="p-6 text-center">2W</th>
                    <th className="p-6 text-center">3W</th>
                    <th className="p-6 text-center">4W</th>
                    <th className="p-6 text-center">Plus</th>
                  </tr>
                </thead>
                <tbody className="divide-y-2 divide-black">
                  {agents.map((a:any) => (
                    <tr key={a.id} className="hover:bg-slate-50">
                      <td className="p-6 font-black text-lg italic">{a.name} CA</td>
                      <td className="p-6 text-center">
