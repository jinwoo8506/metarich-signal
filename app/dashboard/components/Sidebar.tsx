...
export default function Sidebar({ user, selectedDate, onDateChange }: any) {
  ...
  return (
    <aside className="w-full lg:w-80 bg-white border-r p-6 flex flex-col gap-5 shadow-sm z-10 font-black overflow-y-auto">
      ...
      <div className="bg-slate-900 p-5 rounded-[2rem] shadow-xl">
        ...
        <div className="grid grid-cols-2 gap-3 font-black text-white">
      ...
      <div className="space-y-2">
        <p className="text-[9px] text-slate-400 uppercase italic mb-2 tracking-widest px-1">Quick Tools</p>
        <div className="grid grid-cols-2 gap-2">
          <SidebarQuickBtn label="업무툴킷" icon="🛠️" onClick={() => handleOpenLink("/guide.html")} />
          <SidebarQuickBtn label="보험전산" icon="🌐" onClick={() => handleOpenLink("https://xn--on3bi2e18htop.com/")} />
          <SidebarQuickBtn label="자료실" icon="📂" onClick={() => handleOpenLink("https://drive.google.com/...")} />
          <SidebarQuickBtn label="약관조회" icon="📄" onClick={() => handleOpenLink("/terms.html")} />
        </div>
      </div>
