  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] flex text-slate-900 font-sans">
      ...
      <main className="flex-1 p-5 md:p-14 overflow-y-auto">
        ...
        {/* 🚀 MODALS SECTION (main 안으로 이동하여 구조 해결) */}
        {selectedAgent && (
          <div className="fixed inset-0 bg-black/95 backdrop-blur-2xl z-[150] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-6xl rounded-[4rem] p-10 md:p-14 relative overflow-y-auto max-h-[90vh] border-[10px] border-black text-slate-900">
        ...
        {isHistoryModalOpen && (
            <div className="fixed inset-0 bg-black/90 z-[300] flex items-center justify-center p-4">
                <div className="bg-white w-full max-w-4xl rounded-[3rem] p-10 relative border-8 border-black max-h-[85vh] overflow-y-auto text-slate-900">
                    ...
                    <h2 className="text-3xl font-black mb-8 italic uppercase border-b-8 border-black pb-4 text-slate-900">
                            ...
                            agents.map(a => {
                                ...
                                return (
                                    <div key={a.id} className="flex justify-between items-center p-6 bg-slate-50 rounded-2xl border-2">
                                        ...
                                        <div className="flex gap-8 font-bold text-slate-700">
                                            <span>건수: {p.contract_count}건</span>
                                            <span className="text-amber-600">금액: {p.contract_amount}만원</span>
        ...
        {isBizToolOpen && (
          <div className="fixed inset-0 bg-black/95 z-[500] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-4xl rounded-[4rem] p-10 md:p-14 relative border-[8px] border-black text-slate-900">
        ...
        {isNoticeOpen && (
          <div className="fixed inset-0 bg-black/80 z-[200] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-lg rounded-[2.5rem] p-10 relative border-4 border-[#d4af37] text-slate-900">
        ...
        {isTeamGoalModalOpen && (
          <div className="fixed inset-0 bg-black/90 z-[200] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-2xl rounded-[3rem] p-10 border-[6px] border-black text-slate-900">
